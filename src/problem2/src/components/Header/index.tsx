    ...
    */}
          ...
          <div className="hidden lg:ml-4 lg:flex lg:items-center">
            ...
            <div className="relative ml-4 flex-shrink-0">
              <div className="flex flex-row items-center bg-[rgb(255,239,255)] h-10 text-[rgb(252,114,255)] p-0 rounded-full border-[none]">
                <button
                  type="button"
                  className="bg-transparent cursor-pointer font-[535] text-base text-inherit px-3 py-2.5 rounded-tl-full rounded-bl-full border-[none]"
                  id="user-menu-button"
                  aria-expanded="false"
                  aria-haspopup="true"
                >
      ...
      <div className="lg:hidden" id="mobile-menu">
        ...
        <div className="border-t border-gray-200 pt-4 pb-3">
          <div className="relative mx-4 flex-shrink-0">
            <div className="flex flex-row justify-center items-center bg-[rgb(255,239,255)] h-10 text-[rgb(252,114,255)] p-0 rounded-full border-[none]">
              <button
                type="button"
                className="bg-transparent cursor-pointer font-[535] text-base text-inherit px-3 py-2.5 rounded-tl-full rounded-bl-full border-[none]"
                id="user-menu-button"
